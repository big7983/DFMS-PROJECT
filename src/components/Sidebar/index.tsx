...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        label: "รายงานการเข้าอบรม",
        route: "/reporttrainingform",
      },
      {
        icon: (
          <MdAppRegistration />
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`fixed left-0 top-0 z-99 flex h-screen w-72.5 flex-col overflow-y-hidden bg-white duration-300 ease-linear dark:bg-boxdark lg:translate-x-0 ${
